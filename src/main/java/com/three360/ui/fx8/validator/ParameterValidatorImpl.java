...
public class ParameterValidatorImpl implements IParameterValidator {
    ...
    //TODO check negate logic and optimize that . use moore's law
    @Override
        ...
        return this.parameterTS.stream().map(parameterT -> {
            if (parameterT instanceof DataT) {
                ...
                if (dataT.getConstValue() == null)
                    return dataT.getUse().equals(REQUIRED) ? dataT.getName() + " is required" : null;
                ...
                if (stringT.getConstValue() == null)
                    return stringT.getUse().equals(REQUIRED) ? stringT.getName() + " is required" : null;
                ...
                if (utcTimeOnlyT.getConstValue() == null)
                    return utcTimeOnlyT.getUse().equals(REQUIRED) ? utcTimeOnlyT.getName() + "is required" : null;
                ...
                if (tzTimestampT.getConstValue() == null)
                    return tzTimestampT.getUse().equals(REQUIRED) ? tzTimestampT.getName() + "is required" : null;
                ...
                if (localMktDateT == null)
                    return localMktDateT.getUse().equals(REQUIRED) ? localMktDateT.getName() + "is required" : null;
                ...
                if (intT.getConstValue() == null)
                    return intT.getUse().equals(REQUIRED) ? intT.getName() + "is required" : null;
                ...
                if (multipleStringValueT.getConstValue() == null)
                    return multipleStringValueT.getUse().equals(REQUIRED) ? multipleStringValueT.getName() + "is required" : null;
                ...
                if (!((multipleStringValueT.getMinLength() == null
                    ...
                    return parameterT.getName() + "is out of range. Min :" + multipleStringValueT.getMinLength() + "Max : " + multipleStringValueT.getMaxLength();
                }
            } else if (parameterT instanceof TZTimeOnlyT) {
                TZTimeOnlyT tzTimeOnlyT = (TZTimeOnlyT) parameterT;

                if (tzTimeOnlyT.getConstValue() == null)
                    return tzTimeOnlyT.getUse().equals(REQUIRED) ? tzTimeOnlyT.getName() + "is required" : null;
                ...
                if (utcDateOnlyT.getConstValue() == null)
                    return utcDateOnlyT.getUse().equals(REQUIRED) ? utcDateOnlyT.getName() + "is required" : null;
                ...
                if (charValueT.getConstValue() == null)
                    return charValueT.getUse().equals(REQUIRED) ? charValueT.getName() + "is required" : null;
                ...
                if (floatT.getConstValue() == null)
                    return floatT.getUse().equals(REQUIRED) ? floatT.getName() + "is required" : null;
                ...
                if (priceT.getConstValue() == null)
                    return priceT.getUse().equals(REQUIRED) ? priceT.getName() + "is required" : null;
                ...
                if (amtT.getConstValue() == null)
                    return amtT.getUse().equals(REQUIRED) ? amtT.getName() + "is required" : null;
                ...
                if (percentageT.getConstValue() == null)
                    return percentageT.getUse().equals(REQUIRED) ? percentageT.getName() + "is required" : null;
                ...
                if (qtyT.getConstValue() == null)
                    return qtyT.getUse().equals(REQUIRED) ? qtyT.getName() + "is required" : null;
                ...
                if (priceOffsetT.getConstValue() == null)
                    return priceOffsetT.getUse().equals(REQUIRED) ? priceOffsetT.getName() + "is required" : null;
                ...
                if (utcTimestampT.getConstValue() == null)
                    return utcTimestampT.getUse().equals(REQUIRED) ? utcTimestampT.getName() + "is required" : null;
